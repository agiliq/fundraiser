...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.is_approved'
        db.add_column(u'campaigns_campaign', 'is_approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.is_approved'
        db.delete_column(u'campaigns_campaign', 'is_approved')
