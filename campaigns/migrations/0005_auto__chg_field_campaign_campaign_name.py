...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Campaign.campaign_name'
        db.alter_column(u'campaigns_campaign', 'campaign_name', self.gf('django.db.models.fields.CharField')(max_length=60))

    def backwards(self, orm):

        # Changing field 'Campaign.campaign_name'
        db.alter_column(u'campaigns_campaign', 'campaign_name', self.gf('django.db.models.fields.CharField')(max_length=260))
